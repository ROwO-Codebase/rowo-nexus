...
- Status: Accepted
- Date: 2026-08-11
- Scope: wallet, protocol, registry, RP SDK
...
The local RP-origin-to-identity map and human labels remain in IndexedDB. Cross-origin reuse of the
same identity requires explicit confirmation. The registry does not receive intended RP scope during
registration.
